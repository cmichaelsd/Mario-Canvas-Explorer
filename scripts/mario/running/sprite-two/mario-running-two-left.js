function marioRunningTwoLeft() {
  ...
  for (var i = 0; i <= 9; i++) {
    c.fillStyle = red;
    if (i > 5) c.fillStyle = brown;
    if (i === 0 || i === 3) c.fillStyle = tan;
  ...
  for (var i = 0; i <= 9; i++) {
    c.fillStyle = brown;
    if (i < 4 || i === 9) c.fillStyle = red;
    if (i === 3 || i === 4 || i === 5) c.fillStyle = tan;
  ...
  for (var i = 0; i <= 7; i++) {
    c.fillStyle = brown;
    if (i < 3 || i === 7) c.fillStyle = red;
    if (i === 3 || i === 4) c.fillStyle = tan;
